...
:example: https://github.com/hibernate/hibernate-reactive/tree/1.1/examples/session-example
...
:build: https://github.com/hibernate/hibernate-reactive/blob/1.1/examples/session-example/build.gradle
...
:xml: https://github.com/hibernate/hibernate-reactive/blob/1.1/examples/session-example/src/main/resources/META-INF/persistence.xml
...
:log4j: https://github.com/hibernate/hibernate-reactive/blob/1.1/examples/session-example/src/main/resources/log4j2.properties
