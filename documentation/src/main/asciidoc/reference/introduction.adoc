...
the Vert.x client by implementing `SqlClientPoolConfiguration` or `ReactiveConnectionPool`.

|===
| Configuration property name                | Purpose

| `hibernate.vertx.pool.configuration_class` | A class implementing `SqlClientPoolConfiguration`
| `hibernate.vertx.pool.class`               | A class implementing `ReactiveConnectionPool`
|===
