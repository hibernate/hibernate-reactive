...
The following properties are useful for managing schemas and catalogs:
...
| `javax.persistence.create-database-schemas`                | If `true`, automatically create schemas and catalogs
| `javax.persistence.schema-generation.create-script-source` | The name of a SQL script to be executed after tables are exported
|===
