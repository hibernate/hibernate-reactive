...
:example: https://github.com/hibernate/hibernate-reactive/tree/master/examples/session-example
...
:build: https://github.com/hibernate/hibernate-reactive/blob/master/examples/session-example/build.gradle
...
:xml: https://github.com/hibernate/hibernate-reactive/blob/master/examples/session-example/src/main/resources/META-INF/persistence.xml
...
:log4j: https://github.com/hibernate/hibernate-reactive/blob/master/examples/session-example/src/main/resources/log4j2.properties
