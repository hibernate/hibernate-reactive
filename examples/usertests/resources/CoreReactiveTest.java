...
public abstract class CoreReactiveTest {
	...
	protected Configuration constructConfiguration() {
		...
		String jdbcURL = "jdbc:postgresql://localhost:5432/hreact?loggerLevel=OFF&user=hreact&password=hreact";
		String dbType = "PostgreSQL";
		configuration.setProperty( Settings.HBM2DDL_AUTO, "create" );
		configuration.setProperty( "db", dbType );
		configuration.setProperty( Settings.URL, jdbcURL );
		if ( configuration.getProperty( "db" ).equals( "DB2" ) && !doneTablespace ) {
	...
	public CompletionStage<Void> deleteEntities(Class<?>... entities) {
		return deleteEntities( Arrays.stream( entities )
				.map( CoreReactiveTest::defaultEntityName )
	...
	static class SessionFactoryManager {
