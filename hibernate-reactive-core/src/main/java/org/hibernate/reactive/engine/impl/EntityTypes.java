...
public class EntityTypes {
	 ...
	 */
	public static CompletionStage<Object> resolve(
			EntityType entityType, Object idOrUniqueKey, Object owner,
	...
	static boolean isNull(
			EntityType entityType, Object owner,
			SharedSessionContractImplementor session) {
						...
						.thenCompose( isTransient -> {
							if ( isTransient ) {
								...
								if ( copyCache.containsValue( original ) ) {
									...
									final Object copy = session.getEntityPersister(
													entityType.getAssociatedEntityName(),
													original
											)
