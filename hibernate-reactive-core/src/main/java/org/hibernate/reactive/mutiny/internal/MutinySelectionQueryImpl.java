...
public class MutinySelectionQueryImpl<R> implements SelectionQuery<R> {
	...
	@Override
	public SelectionQuery<R> setFlushMode(QueryFlushMode flushMode) {
	...
	@Override
	public Uni<KeyedResultList<R>> getReactiveKeyedResultList(KeyedPage<R> page) {
		return uni( () -> delegate.getReactiveKeyedResultList( page ) );
	}
