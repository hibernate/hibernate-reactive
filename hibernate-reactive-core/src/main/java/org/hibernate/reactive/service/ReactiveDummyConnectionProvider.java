 ...
 * @author Gavin King
 */
public class ReactiveDummyConnectionProvider implements ConnectionProvider, Configurable, Stoppable, ServiceRegistryAwareService {
	private boolean noJDBC;
	private ConnectionProvider delegate;
	private ServiceRegistryImplementor registry;

	public ReactiveDummyConnectionProvider(ConnectionProvider delegate) {
