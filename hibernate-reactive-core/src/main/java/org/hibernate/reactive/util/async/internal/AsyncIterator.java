 ...
 */
package org.hibernate.reactive.util.async.internal;
 ...
 *
 * <p>This interface extends {@link org.hibernate.reactive.util.async.internal.AsyncCloseable}, if there
...
public interface AsyncIterator<T> extends AsyncCloseable {
	...
	enum End {
		...
		/**
		 * An {@link org.hibernate.reactive.util.async.internal.Either} instance which contains the {@link
		 * End} enum.
		 *
		 * @return An {@link org.hibernate.reactive.util.async.internal.Either} containing the {@link End}
		 * instance
		 */
		 ...
		 * org.hibernate.reactive.util.async.internal.Either} containing the {@link End} instance
		 */
		@SuppressWarnings("unchecked")
	 ...
	 * org.hibernate.reactive.util.async.internal.Either#right()} position, or an instance of {@link
	 * End} held in the {@link org.hibernate.reactive.util.async.internal.Either#left()} position
