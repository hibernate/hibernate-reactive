...
public abstract class InsertOrderingReferenceSeveralDifferentSubclassBase extends BaseReactiveTest {
	...
	/*
	 * Test to verify that ORDER_INSERTS = "true" executes a list of expected native insert queries
	 * that reflects removing duplicate queries and ordering them
	 */
	...
	/*
	 * Test to verify that ORDER_INSERTS = "false" executes a list of expected native insert queries
	 * that reflects no removal or ordering of queries
	 */
