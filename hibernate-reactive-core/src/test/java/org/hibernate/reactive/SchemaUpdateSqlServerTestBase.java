...
public abstract class SchemaUpdateSqlServerTestBase extends BaseReactiveTest {
	...
	public static class IndividuallySchemaUpdateSqlServerTestBase extends SchemaUpdateSqlServerTestBase {
	...
	public void testValidationFails(TestContext context) {
		...
		test( context, setupSessionFactory( createHbm2ddlConf )
				.handle( (unused, throwable) -> {
					...
					context.assertEquals( throwable.getMessage(), "Schema-validation: missing table [AAnother]" );
					return null;
				} ) );
	}
