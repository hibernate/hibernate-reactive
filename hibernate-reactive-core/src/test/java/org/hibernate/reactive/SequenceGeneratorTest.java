...
@DisableFor(value = MYSQL, reason = "See https://github.com/hibernate/hibernate-reactive/issues/1525")
@DisableFor(value = COCKROACHDB, reason = "we don't have permission to create schema in the CI!")
