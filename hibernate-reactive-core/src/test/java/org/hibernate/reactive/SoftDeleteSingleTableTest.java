...
public class SoftDeleteSingleTableTest extends BaseReactiveTest {
	...
	public void testTimestampSoftDelete(VertxTestContext context) {
		testSoftDelete( context, timestamp -> timestamp instanceof OffsetDateTime, "deleted", TimestampEntity.class, timestampEntities,
				...
				.withSession( s -> s
						...
						.invoke( tuples -> {
							...
							for ( int i = 0; i < tuples.size(); i++ ) {
								...
								assertThat( tuple.get( "id", Integer.class ) ).isEqualTo( entities[i].getId() );
