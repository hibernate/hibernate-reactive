 ...
 */
@Disabled("@SoftDelete with TABLE_PER_CLASS inheritance appears to have issues - needs investigation")
public class SoftDeleteTablePerClassTest extends BaseReactiveTest {
	...
	protected CompletionStage<Void> cleanDb() {
		return getSessionFactory()
				.withTransaction( s -> s.createNativeQuery( "delete from SpellBookTPC" ).executeUpdate()
						.thenCompose( v -> s.createNativeQuery( "delete from NovelTPC" ).executeUpdate() )
	...
	public void testSoftDeleteWithTablePerClass(VertxTestContext context) {
		test( context, getMutinySessionFactory()
				...
				.call( () -> getMutinySessionFactory().withSession( s -> s
						.createNativeQuery( "select id, title, deleted from SpellBookTPC order by id" )
						.getResultList()
						.invoke( rows -> {
