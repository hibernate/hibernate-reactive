...
class MySQLDatabase implements TestableDatabase {
	...
	/**
	 * Holds configuration for the MySQL database container. By default, Testcontainers will be used.
	 * To use a local MySQL instance instead, run the build with <code>-PskipTestcontainers</code>.
	 * <p>
