...
/**
 * Utility class used to track actual sql queries.
 * <p>
 * Tests must instantiate this class with their desired predicate filter and control bounds of the captured queries.
 */
