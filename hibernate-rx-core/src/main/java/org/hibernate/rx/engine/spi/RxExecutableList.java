...
public class RxExecutableList<E extends RxExecutable & Comparable & Serializable> implements Serializable, Iterable<E>, Externalizable {
	 ...
	 */
	public RxExecutableList(int initialCapacity) {
		// pass true for requiresSorting argument to maintain original behavior
		this( initialCapacity, true );
	}

	public RxExecutableList(boolean requiresSorting) {
		this( INIT_QUEUE_LIST_SIZE, requiresSorting );
	}

	public RxExecutableList(int initialCapacity, boolean requiresSorting) {
		this.sorter = null;
	 ...
	 */
	public RxExecutableList(RxExecutableList.Sorter<E> sorter) {
	 ...
	 * @param sorter The Sorter to use; may be {@code null}
	 */
	public RxExecutableList(int initialCapacity, RxExecutableList.Sorter<E> sorter) {
		this.sorter = sorter;
		this.executables = new ArrayList<E>( initialCapacity );
		this.querySpaces = null;
