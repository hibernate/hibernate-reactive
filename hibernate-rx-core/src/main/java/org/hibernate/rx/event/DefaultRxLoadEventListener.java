...
public class DefaultRxLoadEventListener implements LoadEventListener {
	...
	public static class EventContextManagingLoadEventListenerDuplicationStrategy implements DuplicationStrategy {
		...
		public static final DuplicationStrategy INSTANCE = new EventContextManagingLoadEventListenerDuplicationStrategy();
		...
		public boolean areMatch(Object listener, Object original) {
			if ( listener instanceof RxLoadEvent && original instanceof LoadEventListener ) {
				return true;
			}
