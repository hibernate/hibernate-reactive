...
public class RxUnionSubclassEntityPersister extends UnionSubclassEntityPersister implements RxEntityPersister {

	private static final CoreMessageLogger LOG = CoreLogging.messageLogger( RxUnionSubclassEntityPersister.class );
