 ...
 */
package org.hibernate.reactive.it.techempower.utils;
...
public final class Randomizer {
	...
	private static final FastThreadLocal<ThreadlocalizedRandomizer> localRandom = new FastThreadLocal<>() {
		@Override
		protected ThreadlocalizedRandomizer initialValue() {
	...
	private static Integer[] initRange() {
		ArrayList<Integer> boxedSequence = new ArrayList<>( MAX_OF_RANGE );
